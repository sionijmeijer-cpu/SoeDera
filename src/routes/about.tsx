        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start mb-24">
            ...
            <div className="lg:pt-6">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <a
                  href="mailto:soeren.christensen@soedera.eu"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div className="order-2 lg:order-1 lg:pt-6">
              ...
              <div className="space-y-5 text-slate-600 leading-relaxed mb-8">
                <p>
                  Sylvia has spent more than a decade working at the intersection of information, complexity, and structure across energy and infrastructure. Holding a degree in Business Information Technology and certified in PRINCE2, she built her career from document control through to Product Owner of the Common Data Environment at TenneT, where she led cross-functional squads of business analysts, QA testers, and developers to deliver the asset management application, document management tool, and bulk upload solutions used across a major 2GW offshore wind programme. In that role she acted as both product owner and product manager, working directly with suppliers to ensure the tools delivered met the operational requirements of the engineering teams.
                </p>
                <p>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <a
                  href="mailto:sylvia.awoudu@soedera.eu"
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-slate-100 text-slate-700 rounded-xl hover:bg-slate-200 transition-colors text-sm font-semibold"
                >
