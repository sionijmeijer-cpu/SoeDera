...
// Azure Functions v4 model (default for Node 18+)
module.exports = async function (context, req) {
  const articleId = req.query.article || '';
  
  context.log('SEO Handler called - Article:', articleId);
  
  // If no article or unknown article, redirect to blog index
  ...
  // Return HTML with meta tags in the FIRST bytes
